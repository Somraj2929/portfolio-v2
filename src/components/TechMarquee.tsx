export default function TechMarquee() {
  ...
  return (
    <section className="relative flex w-full overflow-hidden bg-black/20 border-y border-white/5 py-10 mt-12 mb-20 whitespace-nowrap">
      <div className="absolute top-0 left-0 bottom-0 w-32 z-10 bg-gradient-to-r from-[#060810] to-transparent pointer-events-none" />
      <div className="absolute top-0 right-0 bottom-0 w-32 z-10 bg-gradient-to-l from-[#060810] to-transparent pointer-events-none" />
